...
Friend::Friend(QWidget *parent) : QWidget(parent)
{
    ...
    m_pDelDriendPb = new QPushButton("删除好友");
    ...
    pRightPBVBL->addWidget(m_pDelDriendPb);
    ...
    connect(m_pDelDriendPb,SIGNAL(clicked(bool)),this,SLOT(delFriend()));
...
void Friend::updateFriendMsg(PDU *pdu)
{
...
void Friend::delFriend()
{
    if(NULL != m_pFriendListWidget->currentItem())
    {
        ...
        QString strSelfName = TcpCliene::getInstance().loginName();
...
void Friend::privateChat()
{
       ...
       {
           QMessageBox::warning(this,"私聊","请选择要私聊的对象");
       }
}
